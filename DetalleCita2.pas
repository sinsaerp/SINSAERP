  ...
  MessageDlg('¿Está seguro de ' + opcion + ' la cita seleccionada ?',
    ...
    begin
      ...
      begin
        ...
        id := UniMainModule.QueryWeb.FieldByName('id').AsString;
        idApi := UniMainModule.QueryWeb.FieldByName('idapi').AsString;
        consulta :=
            ...
            try
              ...
              begin
                ...
                UniMainModule.Query.Params.ParamByName('Afcodigo').Value :=
                  Documento.Text;
                UniMainModule.Query.Params.ParamByName('Afape1').Value
                  := afape1;
                UniMainModule.Query.Params.ParamByName('Afape2').Value
                  := afape2;
                UniMainModule.Query.Params.ParamByName('Afnom1').Value
                  := afnom1;
                UniMainModule.Query.Params.ParamByName('Afnom2').Value
                  := afnom2;
                ...
                UniMainModule.Query.Params.ParamByName('Nombre').Value :=
                  Paciente.Text;
                UniMainModule.Query.Params.ParamByName('Correo').Value
                  := correo;
                UniMainModule.Query.ExecSQL;
              end
              else
              ...
              UniMainModule.Query.SQL.Add
                ('select MAX(rips)+1  as rips from RipsG');
              UniMainModule.Query.Open();
              ...
              UniMainModule.Query.SQL.Clear;
              UniMainModule.Query.SQL.Add
                ('select numeroc from contratosin where estado=''ACTIVO'' AND citas=''1'' and entidad='''
                + Codigo.Text + '''');
              UniMainModule.Query.Open();
              ...
              UniMainModule.Query.Params.ParamByName('Dependencia').Value
                := '0001';
              ...
              UniMainModule.Query.Params.ParamByName('Medico').Value :=
                codmedico;
              UniMainModule.Query.Params.ParamByName('Consecutivo')
                .Value := rip;
              UniMainModule.Query.Params.ParamByName('Hora').Value :=
              ...
              UniMainModule.Query.Params.ParamByName('HoraCita').Value :=
                FormatDateTime('hh:mm AM/PM', StrToDateTime(Hora.Text));
...
begin
  if not UniMainModule.QueryWeb.IsEmpty then
  begin

    Paciente.Text := UniMainModule.QueryWeb.FieldByName('nombrec').AsString;
    TipoDoc.Text := UniMainModule.QueryWeb.FieldByName('tipidafil').AsString;
    Documento.Text := UniMainModule.QueryWeb.FieldByName('afcodigo').AsString;
    Telefono.Text := UniMainModule.QueryWeb.FieldByName('telefono').AsString;
    Direccion.Text := UniMainModule.QueryWeb.FieldByName('direccion').AsString;
    EPS.Text := UniMainModule.QueryWeb.FieldByName('eps').AsString;
    Fecha.Text := UniMainModule.QueryWeb.FieldByName('fechaCita').AsString;
    FechaSolicitud.Text := UniMainModule.QueryWeb.FieldByName
      ('fechaSolicitud').AsString;
    Medico.Text := UniMainModule.QueryWeb.FieldByName('medico').AsString;
    Hora.Text := UniMainModule.QueryWeb.FieldByName('hora').AsString;
    Descripcion.Text := UniMainModule.QueryWeb.FieldByName
      ('descripcion').AsString;
    Codigo.Text := UniMainModule.QueryWeb.FieldByName('codeps').AsString;
    afape1 := UniMainModule.QueryWeb.FieldByName('afape1').AsString;
    afape2 := UniMainModule.QueryWeb.FieldByName('afape2').AsString;
    afnom1 := UniMainModule.QueryWeb.FieldByName('afnom1').AsString;
    afnom2 := UniMainModule.QueryWeb.FieldByName('afnom2').AsString;
    fechaNacimiento := UniMainModule.QueryWeb.FieldByName
      ('fecha_nacimiento').AsString;
    sexo := UniMainModule.QueryWeb.FieldByName('sexo').AsString;
    correo := UniMainModule.QueryWeb.FieldByName('email').AsString;
    codmedico := UniMainModule.QueryWeb.FieldByName('codmedico').AsString;
    codconsulta := UniMainModule.QueryWeb.FieldByName('codconsulta').AsString;
