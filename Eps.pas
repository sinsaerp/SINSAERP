...
if Codigo.Text = '' then
  ...
  begin
    ...
    if (Nit.Text='') then
    begin
      ShowMessage('Campo Nit esta vació');
      Exit
    end;
    if (DigitoVer.Text='') then
    begin
      ShowMessage('Campo nombre  Digito Verificación esta vacio');
      Exit
    end;
     if (Telefono.Text='') then
    begin
      ShowMessage('Campo teléfono esta  vacio');
      Exit
    end;
    if (Direccion.Text='') then
    begin
      ShowMessage('Campo dirección esta  vacio');
      Exit
    end;
    if (Correo.Text='') then
    begin
