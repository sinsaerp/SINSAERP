...
type
  Tpacientesf = class(TUniForm)
    ...
    Municipio: TUniEdit;
    ubBuscarIdentificacion: TUniSpeedButton;
    ...
    procedure ubBuscarIdentificacionClick(Sender: TObject);
...
procedure Tpacientesf.ubEliminarClick(Sender: TObject);
begin
...
procedure Tpacientesf.ubBuscarIdentificacionClick(Sender: TObject);
begin
  UniMainModule.i := 0;
