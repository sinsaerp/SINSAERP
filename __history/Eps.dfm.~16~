object epsForm: TepsForm
  ...
  object UniPanel1: TUniPanel
    ...
    object ubBuscar: TUniSpeedButton
      Left = 175
      Top = 35
      Width = 35
      Height = 22
  ...
  object UniLabel5: TUniLabel
    ...
    Height = 13
    Hint = ''
    Caption = 'Digito Verificaci'#243'n'
    TabOrder = 4
  end
  object DigitoVer: TUniEdit
    Left = 784
    Top = 124
    Width = 118
    Hint = ''
  ...
  object ubBuscarMunicipio: TUniSpeedButton
    Left = 175
    Top = 243
    Width = 35
    Height = 22
    ...
    Color = clWindow
    TabOrder = 14
    OnClick = ubBuscarMunicipioClick
  end
end
